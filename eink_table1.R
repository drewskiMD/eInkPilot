...
#age means and SD
t.test(control$Age.at.Enrollment..AUTOCALCULATED.,vw$Age.at.Enrollment..AUTOCALCULATED.)
...
t.test(as.numeric(c$a1_smartphone_own),as.numeric(e$a1_smartphone_own))

#computer ownership
mean(as.numeric(c$a2_computer), na.rm = TRUE)
mean(as.numeric(e$a2_computer), na.rm = TRUE)
t.test(as.numeric(c$a2_computer),as.numeric(e$a2_computer))
...
t.test(as.numeric(c$text_ave),as.numeric(e$text_ave))
...
t.test(as.numeric(c$call_ave),as.numeric(e$call_ave))
...
t.test(as.numeric(c$smartphone_ave),as.numeric(e$smartphone_ave))
...
t.test(as.numeric(c$email_ave),as.numeric(e$email_ave))
...
t.test(as.numeric(c$positive_att_ave),as.numeric(e$positive_att_ave))
...
t.test(as.numeric(c$anxiety_ave),as.numeric(e$anxiety_ave))
